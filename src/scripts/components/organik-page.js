...
class OrganikPage extends HTMLElement {
  ...
  createHtmlOrganik(organik) {
    ...
    <div class="card" style="height:550px">
      <img src="${image}" class="lazyload w-100" alt="${name}" tabindex="0" style="height:280px;"/>
      <div class="card-body">
  ...
  async render() {
    this.innerHTML = `
                <div class="container-expand-lg">
                  <h1 class="text-center mt-4" tabindex="0">Tips Organik</h1>
                  ...
                  <div class="input-group mb-3">
                    ...
                    <div class="input-group-append ms-1">
                      <button class="search form-control bg-warning" aria-label="Button Search">
