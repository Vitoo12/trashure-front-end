                ...
                <div class="container-expand-lg pb-5">
                  ...
                  <div class="container-lg pt-3">
                    ...
                    <div class="d-flex align-items-center my-4" style="height:50px">
                      <button class="btn btn-transparent text-light w-100 bg-secondary rounded-pill" id="changePassword"><i class="bi bi-key-fill fs-2 ps-3"></i><span class="fs-3 ms-3">Change Passsword</span></button>
                    </div>
